...
Z([3,'2018 / 动作 / 科幻 / 奇幻'])
Z(z[107])
Z([3,'本·阿弗莱克 / 亨利·卡维尔 / 盖尔·加朵 / 埃兹拉·米勒 / 杰森·莫玛'])
Z([3,'__e'])
Z([3,'movie-oper'])
...
var aZ=_mz(z,'hello-comp',['bind:__l',1,'myval',1,'vueId',2],[],e,s,gg)
_(lY,aZ)
var t1=_mz(z,'trailer-stars',['bind:__l',4,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(lY,t1)
var e2=_mz(z,'swiper',['autoplay',8,'circular',1,'class',2,'duration',3,'indicatorDots',4,'interval',5],[],e,s,gg)
var b3=_n('swiper-item')
var o4=_mz(z,'image',['class',14,'src',1],[],e,s,gg)
_(b3,o4)
_(e2,b3)
var x5=_n('swiper-item')
var o6=_mz(z,'image',['class',16,'src',1],[],e,s,gg)
_(x5,o6)
_(e2,x5)
...
var lCB=_mz(z,'image',['class',24,'src',1],[],e,s,gg)
_(oBB,lCB)
var aDB=_n('view')
...
_(cAB,oBB)
_(lY,cAB)
var eFB=_mz(z,'scroll-view',['class',28,'scrollX',1],[],e,s,gg)
var bGB=_n('view')
_rz(z,bGB,'class',30,e,s,gg)
var oHB=_n('view')
_rz(z,oHB,'class',31,e,s,gg)
var xIB=_mz(z,'image',['class',32,'src',1],[],e,s,gg)
_(oHB,xIB)
var oJB=_n('view')
...
_(oJB,fKB)
_(oHB,oJB)
var cLB=_mz(z,'trailer-stars',['bind:__l',36,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(oHB,cLB)
_(bGB,oHB)
_(eFB,bGB)
var hMB=_n('view')
...
var cOB=_mz(z,'image',['class',42,'src',1],[],e,s,gg)
_(oNB,cOB)
var oPB=_n('view')
...
_(oPB,lQB)
_(oNB,oPB)
var aRB=_mz(z,'trailer-stars',['bind:__l',46,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(oNB,aRB)
_(hMB,oNB)
_(eFB,hMB)
var tSB=_n('view')
...
var bUB=_mz(z,'image',['class',52,'src',1],[],e,s,gg)
_(eTB,bUB)
var oVB=_n('view')
...
_(oVB,xWB)
_(eTB,oVB)
var oXB=_mz(z,'trailer-stars',['bind:__l',56,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(eTB,oXB)
_(tSB,eTB)
_(eFB,tSB)
var fYB=_n('view')
...
var h1B=_mz(z,'image',['class',62,'src',1],[],e,s,gg)
_(cZB,h1B)
var o2B=_n('view')
...
_(o2B,c3B)
_(cZB,o2B)
var o4B=_mz(z,'trailer-stars',['bind:__l',66,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(cZB,o4B)
_(fYB,cZB)
_(eFB,fYB)
var l5B=_n('view')
...
var t7B=_mz(z,'image',['class',72,'src',1],[],e,s,gg)
_(a6B,t7B)
var e8B=_n('view')
...
_(e8B,b9B)
_(a6B,e8B)
var o0B=_mz(z,'trailer-stars',['bind:__l',76,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(a6B,o0B)
_(l5B,a6B)
_(eFB,l5B)
var xAC=_n('view')
...
var fCC=_mz(z,'image',['class',82,'src',1],[],e,s,gg)
_(oBC,fCC)
var cDC=_n('view')
...
_(cDC,hEC)
_(oBC,cDC)
var oFC=_mz(z,'trailer-stars',['bind:__l',86,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(oBC,oFC)
_(xAC,oBC)
_(eFB,xAC)
_(lY,eFB)
...
var oNC=_mz(z,'image',['class',98,'src',1],[],e,s,gg)
_(bMC,oNC)
var xOC=_n('view')
...
_(oPC,fQC)
_(xOC,oPC)
var cRC=_mz(z,'trailer-stars',['bind:__l',103,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(xOC,cRC)
var hSC=_n('view')
_rz(z,hSC,'class',107,e,s,gg)
var oTC=_oz(z,108,e,s,gg)
_(hSC,oTC)
_(xOC,hSC)
var cUC=_n('view')
...
_(xOC,cUC)
_(bMC,xOC)
var lWC=_mz(z,'view',['bindtap',111,'class',1,'data-event-opts',2],[],e,s,gg)
var aXC=_mz(z,'image',['class',114,'src',1],[],e,s,gg)
_(lWC,aXC)
var tYC=_n('view')
...
_(tYC,eZC)
_(lWC,tYC)
var b1C=_mz(z,'view',['animation',118,'class',1],[],e,s,gg)
